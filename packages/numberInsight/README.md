...
@vonage/cli-plugin-numberinsight/1.0.0 linux-x64 node-v12.18.2
...
_See code: [dist/commands/numberinsight/index.js](https://github.com/Vonage/vonage-cli/blob/v1.0.0/dist/commands/numberinsight/index.js)_
<!-- commandsstop -->
