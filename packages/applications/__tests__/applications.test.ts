...
describe('Apps:Link', () => {
    ...
    test.env({ VONAGE_API_KEY: '12345', VONAGE_API_SECRET: 'ABCDE' })
        .nock('https://rest.nexmo.com/account', (api) =>
            api
                .get('/numbers')
                .query({
                    pattern: '15555555555',
        ...
        .nock('https://rest.nexmo.com/number', (api) =>
            api
                .post('/update')
                .query({
                    app_id: '1234-5678-abcd-efgh',
                    country: 'US',
                    msisdn: '15555555555',
                    api_key: '12345',
                    api_secret: 'ABCDE',
        ...
        .it('Links phone number', (ctx) => {
            expect(ctx.stdout).to.equal(
                `Number '15555555555' is assigned to application '1234-5678-abcd-efgh'.\n`,
            );
        });
});
