...
export default [
  {
    ...
    expected: [
      ...
      ...envNotSet,
      ...argsNotSet,
      'The derived API key is: global-key',
      'The derived API secret is: global-secret',
      'The derived application ID is: global-application',
      'The derived private key is: global-private-key',
      '',
    ],
    clearEnv: true,
  },
  {
    ...
    expected: [
      ...
      ...envNotSet,
      ...argsNotSet,
      'The derived API key is: local-key',
      'The derived API secret is: local-secret',
      'The derived application ID is: local-application',
      'The derived private key is: local-private-key',
      '',
    ],
    clearEnv: true,
  },
  {
    ...
    expected: [
      ...
      ...envSet,
      ...argsNotSet,
      'The derived API key is: env-key',
      'The derived API secret is: env-secret',
      'The derived application ID is: env-app-id',
      'The derived private key is: env-private-key',
      '',
    ],
    clearEnv: false,
  },
  {
    ...
    expected: [
      ...
      ...envNotSet,
      ...argsSet,
      'The derived API key is: args-key',
      'The derived API secret is: args-secret',
      'The derived application ID is: args-app-id',
      'The derived private key is: args-private-key',
      '',
    ],
    clearEnv: true,
  },
