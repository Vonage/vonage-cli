...
describe('apps:conversations:show', () => {
    test.stdout()
        .nock(baseHost, (api) =>
            api.get('/conversations/12345').reply(200, conversationResponse),
        )
    ...
    test.stdout()
        .nock(baseHost, (api) =>
            api.get('/conversations/12345').reply(400, genericFailedError),
        )
        .command(['apps:conversations:show', '12345'])
        .catch((ctx) => {
    ...
    test.stdout()
        .nock(baseHost, (api) =>
            api.get('/conversations/12345').reply(401, genericAuthError),
        )
        .command(['apps:conversations:show', '12345'])
        .catch((ctx) => {
    ...
    test.stdout()
        .nock(baseHost, (api) =>
            api.get('/conversations/12345').reply(404, notFoundError),
        )
        .command(['apps:conversations:show', '12345'])
        .catch((ctx) => {
    ...
    test.stdout()
        .nock(baseHost, (api) =>
            api.get('/conversations/12345').reply(500, internalError),
        )
        .command(['apps:conversations:show', '12345'])
        .catch((ctx) => {
